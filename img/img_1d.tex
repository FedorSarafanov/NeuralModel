...
\definecolor{color5}{HTML}{43459d}
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
	     ...
	     % \xdef\C{5e-8}
		\addplot +[lin,color0,opacity=0.4,fst] plot [error bars/.cd, y dir = both, y explicit] table [x expr=\thisrow{x}*0.8, y expr=\thisrow{y}*10] {../data/img_1d_1.tsv} 
			node[left,pos=0,black,opacity=1] {$0$ мА};
		\addplot +[lin,color1,opacity=0.5,fst] plot [error bars/.cd, y dir = both, y explicit] table [x expr=\thisrow{x}*0.8, y expr=\thisrow{y}*10]{../data/img_1d_2.tsv}
			node[left,pos=0,black,opacity=1] {$-0.23$ мА};
		\addplot +[lin,color2,opacity=0.7,fst] plot [error bars/.cd, y dir = both, y explicit] table [x expr=\thisrow{x}*0.8, y expr=\thisrow{y}*10] {../data/img_1d_3.tsv}
			node[left,pos=0,black,opacity=1] {$-0.34$ мА};
		% \addplot +[lin] plot [error bars/.cd, y dir = both, y explicit] table {../data/line4.tsv};
		\addplot +[lin,color3,opacity=1,fst] plot [error bars/.cd, y dir = both, y explicit] table [x expr=\thisrow{x}*0.8, y expr=\thisrow{y}*10] {../data/img_1d_4.tsv}
